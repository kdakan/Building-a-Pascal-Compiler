...
I don't have much left from the Pascal compiler I built in 1997 when I was a student at the university. 
I remember at that time I wrote some 10-15 thousand lines of C code, but in the early 2000s, the code was lost because the floppy disk died. 
In 1998, I created an article on fortunecity.com, as an introduction to this compiler, and I was able to find a copy of that article from archive.org. 
I reformatted this article and put it on GitHub. 
The techniques I was using at the time also apply to the present, as nothing has changed in compiler design since the 1960s.
